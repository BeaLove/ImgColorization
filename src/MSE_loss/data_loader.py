...
#import misc.npy_loader.loader as npyf
...
weight_mix = torch.tensor(np.load('../../npy/weight_distribution_mix_with_uniform_distribution_reduced_normalized.npy'))
...
class Dataset(torch.utils.data.Dataset):
	...
	def __getitem__(self, i):
		im = util.load_img(str(self.dataset[i]))
		X, Y = util.preprocess_img(im)
		return X, Y # , Z
